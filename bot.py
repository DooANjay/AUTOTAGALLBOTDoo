...
def build_log_start(a, b, c, d, e, f):
    ...
    res = (
        ...
        f"> **PARTNER :** {e}\n\n"
        f"> **Telegram**\n"
        f"> **SHINBI'S ft KOISLOT**\n"
        f"> WELCOME TO SHINBI'S MUTUALAN\n"
        f"> ━━━━━━━━━━━━━━━━━━━━\n"
        f"> **RULES GROUP :**\n"
        f"> {clean_f}"
    )
...
# Fitur Baru: /cancel untuk membatalkan input multistep penambahan partner
...
async def handle_multistep_input(event):
    ...
    if user_text.startswith("/cancel"): return # Ditangani oleh perintah cancel khusus
